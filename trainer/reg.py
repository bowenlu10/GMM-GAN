...
class Reg(nn.Module):
    def __init__(self, input_nc, output_nc):
        ...
        # 通道数
        in_channels_a,in_channels_b=input_nc,output_nc
        init_func = 'kaiming'
        ...
        self.offset_map = ResUnet(self.in_channels_a, self.in_channels_b, cfg='A_img', init_func=init_func, init_to_identity=init_to_identity).to(
            self.device)
